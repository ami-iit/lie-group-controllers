...
TEST_CASE("Proportional Controller [SO(3)] with scalar kp - Right Trivialization")
{
    manif::SO3d desiredState, state;
    desiredState.setRandom();
    state.setRandom();
...
TEST_CASE("Proportional Controller [SE(3)] - Right Trivialization")
{
    manif::SE3d desiredState, state;
    desiredState.setRandom();
    state.setRandom();
    ...
    // instantiate the controller
    ProportionalControllerTplSE3d<Trivialization::Right> controller;
    constexpr double kp = 10;
    controller.setGains(kp);
    controller.setDesiredState(desiredState);
    controller.setFeedForward(feedForward);
